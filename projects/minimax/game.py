...
class Game:
    ...
    def __moveable_to(self, cell, state):
        ...
        return (
            # In bounds
            0 <= x < self.dim and 0 <= y < self.dim and
            # Tile in cell
    ...
    def get_actions(self, state):
        ...
        legal_dests = [
            ...
            if (
                ...
                self.__moveable_to((px + x, py + y), state)  # valid move
            )
        ]
    ...
    def apply_action(self, state, action):
        ...
        """
        (mx, my), (dx, dy) = action  # move pos and delete pos
    ...
    def utility(self, state):
        ...
        # If min turn to play and no moves, utility 1 (utility for max)
    ...
    def play(self, min, max, verbose=True):
        ...
        num_moves = 0
        move_order = [min, max] if cur_state.min_to_play else [max, min]
